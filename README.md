...
* Social logins support with token based authentication, Follow [this](https://github.com/like-a-fox/LikeAFoxAspNg/wiki/Social-Login-Setup) wiki page to see how it will work.
...
```
1. Clone the repo
    git clone https://github.com/like-a-fox/LikeAFoxAspNg
2. Change directory
    cd LikeAFoxAspNg
3. Run Server
    dotnet build LikeAFoxAspNg.sln
