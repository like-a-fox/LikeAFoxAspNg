using LikeAFoxAspNg.Web.Extensions;
using LikeAFoxAspNg.Web.SignalR;
using LikeAFoxAspNg.Core.ViewModels;
using AutoMapper;
...
namespace LikeAFoxAspNg.Web
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                configuration.RootPath = "ClientApp/dist/LikeAFoxAspNg";
            });

            services.AddSwaggerGen(c =>
            {
                c.SwaggerDoc("v1", new Info { Title = "LikeAFoxAspNg", Version = "v1" });
            ...
            app.UseSpa(spa =>
                      {
                          ...
                          // [1] In LikeAFoxAspNg.csproj, change the <BuildServerSideRenderer> property
