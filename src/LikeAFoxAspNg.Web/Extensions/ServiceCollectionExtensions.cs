...
using LikeAFoxAspNg.Web.Filters;
using LikeAFoxAspNg.Infrastructure.Services;
...
using LikeAFoxAspNg.Infrastructure;

namespace LikeAFoxAspNg.Web.Extensions
{
    public static class ServiceCollectionExtensions
    {
        ...
        public static IServiceCollection AddCustomDbContext(this IServiceCollection services)
        {
            ...
            services.AddDbContextPool<ApplicationDbContext>(options =>
            {
                ...
                {
                    options.UseInMemoryDatabase("LikeAFoxAspNg"); // Takes database name
                }
                else if (useSqLite.ToLower() == "true")
                {
                    var connection = Startup.Configuration["Data:SqlLiteConnectionString"];
                    options.UseSqlite(connection);
                    options.UseSqlite(connection, b => b.MigrationsAssembly("LikeAFoxAspNg.Web"));
                ...
                else
                {
                    ...
                    options.UseSqlServer(connection, b => b.MigrationsAssembly("LikeAFoxAspNg.Web"));
                }
